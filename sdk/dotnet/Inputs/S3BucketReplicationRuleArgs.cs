...
namespace Pulumi.Minio.Inputs
{
    ...
    public sealed class S3BucketReplicationRuleArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.S3BucketReplicationRuleTargetArgs> Target { get; set; } = null!;

        public S3BucketReplicationRuleArgs()
        {
        }
        public static new S3BucketReplicationRuleArgs Empty => new S3BucketReplicationRuleArgs();
    }
}
